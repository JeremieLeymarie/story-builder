  ...
  "rounded-full px-1.5 py-0.5 text-xs font-semibold select-none",
  {
    variants: {
      level: {
        ...
        10: "bg-progress/10 text-foreground",
        20: "bg-progress/20 text-foreground",
        30: "bg-progress/30 text-foreground",
        40: "bg-progress/40 text-foreground",
        50: "bg-progress/50 text-foreground",
        60: "bg-progress/60 text-foreground",
        70: "bg-progress/70 text-white",
        80: "bg-progress/80 text-white",
        90: "bg-progress/90 text-white",
        100: "bg-progress text-white",
      },
    },
    defaultVariants: {
      level: 0,
